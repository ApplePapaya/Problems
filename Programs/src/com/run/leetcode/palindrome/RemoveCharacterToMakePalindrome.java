...
public class RemoveCharacterToMakePalindrome {
	...
	public static void main(String[] args) {
		...
		Arrays.stream(arr)
		           .forEach(s-> System.out.println(String.format("%s  %d" ,s,isSingleCharRemovalMakeValidPalindrome(s))));

	}

	private static int isSingleCharRemovalMakeValidPalindrome(String s) {

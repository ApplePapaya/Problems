 ...
 * 1 <= weights[i] <= 500
 */
public class CapacityToShipPackageWithinDDays1011 {
    /**
    ...
    private boolean isWork(int min, int[] weights, int days) {
        int sum = 0;
        int i = 0;
    ...
    public int shipWithinDays22(int[] weights, int D) {
        int left = 0, right = 0;
        for (int w: weights) {
